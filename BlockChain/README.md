...
- Each block stores their own UTXO set for easy work calculation for getting the tip of a block chain. In real blockchains, only the tip's UTXO state is saved for memory purposes.
